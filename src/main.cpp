...
// Set your motors/electronic configuration here!
...
//******************************************************************************//
// Go into config.h to change your motor port or if you want to reverse the motor//
//*******************************************************************************//
...
// clear the entire LCD
	...
	lcd::print(0, "Brake Mode Test");
	lcd::print(1, "Start using RIGHT arrow btn");
	...
	brake_move_relative();
	brake_move_velocity();
	// calling the brake mode functions
